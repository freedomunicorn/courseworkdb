    ...
    public partial class Billings : Form
    {
        ...
        private void Bill()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@EN", Login.empname);
        ...
        private void Savebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Данное кол-во недоступно");
            }
        ...
        {
            e.Graphics.DrawString("Зоомагазин", new Font("Century Gothic",12,FontStyle.Bold),Brushes.Red, new Point(50));
            e.Graphics.DrawString("ИДЕНТИФИКАТОР ЦЕНА ПРОДУКТА КОЛИЧЕСТВО ВСЕГО", new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Red, new Point(5,20));
            ...
            e.Graphics.DrawString("Общая сумма: BYN " + GrdTotal, new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Crimson, new Point(50 , pos + 50));
            e.Graphics.DrawString("***************Зоомагазин***************", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Crimson, new Point(0, pos + 85));
            BillDGV.Rows.Clear();
            BillDGV.Refresh();
            pos = 100;
            GrdTotal = 0;
